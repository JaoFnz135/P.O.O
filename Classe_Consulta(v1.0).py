...
def faturamentoClinica(d):
    ...
    for cod, cons in d.items():
        ...
        if data_consulta.month == mes:
            ...
            print('_'*55)
            cont += 1
    print(f'O faturamento da clinica esse mês foi de: {faturamento*cont}') 
...
def main():
    ...
    while True:
        ...
        #Agendar o retorno.        
        if r == 4:
            agendar_retorno(dic_retorno,dic_consultas)
        ...
        if r == 7:
            ...
            #Não é possível printar o retorno / OBS: Aperfeiçoar depois.
            mostrar_consultas(dic_retorno)
